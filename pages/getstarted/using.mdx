...
Splits can currently receive ETH and ERC20s.
...
that NFT with up to 3 other addresses natively through Foundation. Using
0xSplits within Foundation is very easy and has more functionality & benefits.
All you have to do is paste your Split’s address into the recipient field while
[creating a Foundation split](https://help.foundation.app/en/articles/5305276-how-can-i-create-a-split-on-foundation).

Whenever a work is sold on Foundation, your Split recipients will receive their
...
- You can include more recipients using 0xSplits. Foundation limits you to 4
...
user to specify this address through their app/interface directly, but we hope
this is coming soon (since it already exists on their contracts!).

That said, it's very easy to integrate 0xSplits into Zora's contracts if you're
a developer. All you have to do is set the
