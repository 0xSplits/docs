...
wallet, or smart contract, including those with hard gas limits.

<Callout type="warning" emoji="🚨">
  Only send **ETH and ERC20s** to a Split. NFTs & other tokens sent to a Split
  will be permanently lost.
</Callout>

You can locate a Split's address within the [app](https://app.0xsplits.xyz/) by
viewing its detail page. See an
[example here](https://app.0xsplits.xyz/accounts/0xF8843981e7846945960f53243cA2Fd42a579f719/).
The Split's address is displayed 1) within the "Address" section in the upper
right of the page, and 2) in the URL of the page itself.
