...
is an example. The Split's address is at the top of the page. Click on the
address to copy it to your clipboard. You can use your Split's address anytime
you want funds split according to this configuration.

![Copy Split Address](/copy-address.gif)

The Split's address is also displayed in the URL. It is the text after
...
with third party platforms. Below are a few platforms where people are using
Splits today.
