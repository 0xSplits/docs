...
Instructions for distributing balances using the app are [here](/distribute),
...
<Toggle title="Why is this step necessary?">
  ...
  the contract, which creates an arbitrage opportunity and incentivizes third
  parties to execute distributions automatically.
</Toggle>
...
earn from. Since anyone can withdraw on behalf of any recipient (instructions
[here](/withdraw)), recipients can be any account, smart contract, or exchange
address.
