...
<div className="flex items-stretch space-x-4">
  <div className="w-2 mt-9 rounded-full bg-green-500" />
  ## Receiving
</div>
...
You can learn more about sending funds to a contract [here](/use) and technical
details are [here](/contracts/core/split).

<div className="flex items-stretch space-x-4">
  <div className="w-2 mt-9 rounded-full bg-yellow-400" />
  ## Distributing
</div>
...
<div className="flex items-stretch space-x-4">
  <div className="w-2 mt-9 rounded-full bg-red-500" />
  ## Withdrawing
</div>
...
transfers _all funds_ from _all the contracts_ for a recipient. This saves
people from having to initiate separate withdrawals for each contract they earn
from. Since anyone can withdraw on behalf of any recipient, recipients can be
any account, smart contract, or exchange address.
