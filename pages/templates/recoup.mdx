...
- We recommend familiarizing yourself with how [Waterfall](/core/waterfall) and
  [Split](/core/split) work, since Recoup is just a factory to make it easier to deploy those
  building blocks composed together in a single transaction.
- Any non-target tokens sent to the Recoup will be recovered to the final
