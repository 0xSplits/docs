...
into a stablecoin and set aside for taxes. This template simply stacks a [Pass-Through Wallet](https://github.com/0xSplits/splits-pass-through-wallet) on top of a [Split](/core/split) on top of a number of [Swappers](/core/swapper).
