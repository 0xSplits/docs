...
[Liquid Split functions](/modules/liquid-splits).
...
[Liquid Split contracts](/modules/liquid-splits).

### getDistributorFee

Returns the distributor fee a given `liquidSplitId`.
...
Returns the payout split for a given `liquidSplitId`.
...
Returns the owner a given `liquidSplitId`.
...
Returns the uri a given `liquidSplitId`.
