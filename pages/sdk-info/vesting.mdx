...
[Vesting functions](/modules/vesting).
...
vesting module function would look like:
...
[Vesting contracts](/modules/vesting).
...
Returns the vested and unreleased amount for a given `vestingModuleId` and `streamId`.
