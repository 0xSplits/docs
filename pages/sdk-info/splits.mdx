...
Not all providers handle it properly. Alchemy and Infura are the two we currently
support. For other providers, we require a erc20TokenList argument to get passed in.
You can specify which erc20 tokens to fetch a balance for, or pass an empty array.
