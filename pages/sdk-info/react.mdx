...
[Core SDK](/sdk-info/overview). The React SDK provides convenient hooks for easily
fetching splits data and sending transactions. You can find the React SDK source
code on [Github](https://github.com/0xSplits/splits-sdk/tree/main/packages/splits-sdk-react).
...
Each of the transaction functions from the core sdk has a react hook wrapper. It returns
the core sdk function and some state properties for monitoring the transaction progress.
