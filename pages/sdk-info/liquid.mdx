...
```graphql
{
  ...
  # General rule-of-thumb is if there are not a lot of recipients, it will
  # likely be more gas efficient to set createClone to true. In the 0xsplits
  # webapp, we always set createClone to true when creating a liquid split.
