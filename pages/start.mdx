...
[app.0xsplits.xyz](https://app.0xsplits.xyz/). You don't need to connect your
wallet to play around with the app and get a feel for what it's like to create a
contract. You will, however, need to connect your wallet in order to submit a
transaction like creating a contract, withdrawing a balance, and so on.
