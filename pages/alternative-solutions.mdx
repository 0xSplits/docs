...
We drew considerable inspiration from Mirror and a few others in this space. We focused on 3 key differentiating areas when designing this protocol: composability, gas efficiency & fairness, and onchain-ness.
...
- Splits can withdraw to contracts/accounts that don't have direct access to the private keys using `withdrawFor`

### Gas-efficiency

- Splits is ~5x for more efficient for Splits < 500; ~2.5x for > 500 (2-layer Split) [add data]
...
- Splits costs **significantly** less to deploy [add data]
- Splits is more gas efficient to distribute [add data]
