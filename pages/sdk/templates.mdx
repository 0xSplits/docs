...
protocol subgraph will pick this up so that these Recoup Waterfalls can be displayed
differently.
...
helper contract and the protocol subgraph will pick this up so that these Diversifiers can be displayed
properly in the protocol explorer.
