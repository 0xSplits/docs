...
Withdraws the funds for the passed in recipient that were set aside after a `waterfallFunds` call
with `usePull` set to true.
...
These functions make it easier to query the [Waterfall contracts](/modules/waterfall).
