...
Generating call data for the create waterfall module function would look like:
...
Returns the non-waterfall recipient for a given `waterfallModuleAddress`. If none was
...
Returns the balance set aside for withdrawal for a given `waterfallModuleAddress` and
recipient address.
