...
<Card image arrow title="Split" href="#split">
  <>![Basic split diagram](./img/create_split_diagram.png)</>
</Card>
<Card image arrow title="Waterfall" href="#waterfall">
  <>![Basic waterfall diagram](./img/create_waterfall_diagram.png)</>
</Card>
<Card image arrow title="Vesting" href="#vesting">
...
- [Create a Recoup](https://app.0xsplits.xyz/new/split)
...
- [Create a Recoup](https://app.0xsplits.xyz/new/waterfall)
- [Technical docs](/contracts/core/waterfall)
- [Contracts](https://github.com/0xSplits/splits-waterfall)

### Vesting

Vesting is a contract that releases isolated streams of tokens to a recipient
over a set period of time. When creating a Vesting contract, all you need to do
it set the recipient and the number of days it takes for each vesting stream to
complete.
...
- [Technical docs](/contracts/core/vesting)
