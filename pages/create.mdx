...
There are three core contracts (i.e., building blocks) upon which all payment
flows are built. You can stack them together in whatever order makes most sense
...
<Card title="Split" image href="#split">
  ![Basic Overview Flow](/split_diagram.png)
</Card>
<Card title="Waterfall" image>
  ![Basic Overview Flow](/waterfall_diagram.png)
</Card>
<Card title="Stream" image>
