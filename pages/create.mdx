...
blocks are intentionally unopinionated, however, for more opinionated payment
...
[split.new](https://app.splits.org/new/split/) and enter in two or more
recipients.
...
- [Create a Split](https://app.splits.org/new/split)
...
[waterfall.new](https://app.splits.org/new/waterfall) and entering in the
...
- [Create a Waterfall](https://app.splits.org/new/waterfall)
...
- [Create a Recoup](https://app.splits.org/new/recoup)
...
- [Create a Liquid Split](https://app.splits.org/new/split/?type=liquid)
