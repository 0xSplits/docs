...
The below diagram illustrates the key components of the protocol and highlights the different methods for moving funds between the components. As an [Owner](/core-concepts#owner), you don't actually have to worry about any of this, since the [Splitter Fee](/core-concepts#splitter-fee) incentivizes third parties to call functions (e.g. `splitBalanceFor`) on your behalf.
