...
A Waterfall acts as a debt instrument by letting you order distributions. It's
useful when you want to pay one party a specific amount _before_ paying a
different party. Just like a Split, a Waterfall is a payable smart contract that
can be plugged into any payment flow. Try it out at
[waterfall.new](https://app.0xsplits.xyz/new/waterfall/).

![Waterfall diagram](/waterfall_diagram.png)
