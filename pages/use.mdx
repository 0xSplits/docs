...
Double check the network you're viewing or the wallet you're connected to if
you're having trouble locating specific contracts. Drop us a note in the
`user-support` channel in [Discord](https://chat.0xsplits.xyz/) if you're still
having trouble.

## Third Party Platforms

These contracts are designed to be used with other platforms within the
ecosystem. Below are a few places where people are using them today, but in
every case **all you have to do is paste your contract address into the payout
field**.
