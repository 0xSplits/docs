...
<div className="text-xl text-gray-500">
  Learn how the protocol is used to manage onchain revenue
</div>

The protocol is a set of composable,
...
just want to understand how you can use the protocol today, we recommend you check out our
...
Teams, platforms, and projects of all sizes rely on the protocol to manage or help their users manage
