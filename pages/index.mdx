...
0xSplits is a composable, gas-efficient, and trustless protocol for splitting
onchain income. Its [live](https://app.0xsplits.xyz/) on Ropsten and coming soon
to Ethereum & EVM compatible chains.
...
- **Onchain Collaboration**: Income from minting NFTs & royalties from secondary
  ...
  disbursements or ongoing maintenance. If the team's work was inspired by
  another project, they can make that project a small Owner in their Split as a
...
- **Giving Back**: Rather than listing a single donation address for an open
  ...
  without anyone having to manage it or trust one another. The developers may
  also grant a multisig the ability to modify the Split, allowing them change
  the Split's composition in the future as collaborators change.
...
We believe splits introduce a novel way to fund public goods, and we're
dogfooding the protocol in this regard. If you'd like to support 0xSplits, all
...
gives back to the communities that helped get us to launch.
