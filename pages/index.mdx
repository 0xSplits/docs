...
gas cost and charges no fees whatsoever. It's designed as a
[hyperstructure](https://jacob.energy/hyperstructures.html), meaning it can run
for free, forever, without maintenance or trusted third parties.

We believe splits introduce a **novel way to fund public goods**, and so it's
being testing it on itself. If you'd like to support 0xSplits, all you have to
do is add
[0xsplits.eth](https://etherscan.io/address/0x50671995e1eca15ca9e807774a814331cabe0f3b)
as a Recipient in the Splits you create. 0xsplits.eth is itself a Split, which
gives back to the communities that have supported us to date.
