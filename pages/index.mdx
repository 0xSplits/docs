...
that distributes cryptocurrencies (ETH & ERC-20 tokens) proportionally among the
Recipients. A Recipient is any address (i.e., externally owned account or smart
contract like another Split) that receives a share of the Split's income.
Whenever a Split's [balance](/core-concepts/#balance) is distributed, each
Recipient is allocated their share.
...
you're a developer looking to integrate Splits, you may want to skip ahead to
