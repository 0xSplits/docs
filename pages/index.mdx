...
0xSplits is a composable, non-upgradable protocol for splitting onchain income.
Running exactly at gas and charging no fees whatsoever, it takes the form of a
[hyperstructure](https://jacob.energy/hyperstructures.html) that can run for
free, forever, without any maintenance or trusted third parties. The protocol is
...
These docs are designed to be progressively more technical the further you read.
If you're non-technical, new to Ethereum, or just want to understand how you can
use 0xSplits today, we recommend you continue reading. If you're integrating the
contracts into your own app or contracts, you may want to skip ahead to the
