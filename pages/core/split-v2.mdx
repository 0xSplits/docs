...
<Callout>
Mainnet USDT is not an ERC20 token and not compatible with Splits V2.0 or V2.1 ([learn more](https://splits.org/blog/dont-send-mainnet-usdt-to-immutable-v2-1-splits/)). We are working on V2.2 to fix this.
</Callout>
