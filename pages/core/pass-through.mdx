...
Pass-Through Wallet is a payable, ownable smart contract wallet with pausable token forwarding.
...
At any time the owner may pause `passThroughTokens`, update the pass-through address, or execute arbitrary calls from the Pass-Through Wallet.
