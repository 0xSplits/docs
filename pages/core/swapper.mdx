...
owner can withdraw those tokens at any time.
...
- Each Swapper is a payable smart contract with a beneficiary, output token (ETH
  ...
  offers one [oracle](/core/oracle), which uses Uniswap v3 TWAP to price assets.
...
| Contract       | Address                                                                                                                     |
| :------------- | :-------------------------------------------------------------------------------------------------------------------------- |
| Implementation | [`0x7fcdD45101E35fd626A539BA565d26A72d95fDa7`](https://basescan.io/address/0x7fcdD45101E35fd626A539BA565d26A72d95fDa7#code) |
| Factory        | [`0xa244bbe019cf1BA177EE5A532250be2663Fb55cA`](https://basescan.io/address/0xa244bbe019cf1BA177EE5A532250be2663Fb55cA#code) |
