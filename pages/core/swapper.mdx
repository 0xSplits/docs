...
- Each Swapper is a payable smart contract with a specified beneficiary, output
  ...
  **use a secure oracle** with sensible defaults & overrides for desired
  ...
  TWAP, but you can use whatever oracle you'd like as long as it extends
  [this abstract contract](https://github.com/0xSplits/splits-oracle/blob/main/src/OracleImpl.sol).
