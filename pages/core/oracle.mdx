...
Our platform integrates Chainlink data feeds for onchain price reference.
Chainlink ensures the integrity of price data by providing updated values with a
defined frequency and deviation threshold, termed as heartbeat and threshold,
respectively. These parameters help maintain data relevancy during varying
market conditions. For comprehensive technicalities, the Chainlink
[documentation](https://docs.chain.link/data-feeds) serves as a resourceful
reference.
