...
- Any non-permitted tokens sent to the Waterfall may be recovered to any of the
  tranche recipients.
- This contract was not designed for a large number of tranches, please make sure that the total number of tranches don't exceed the transaction gas limit of the network.
